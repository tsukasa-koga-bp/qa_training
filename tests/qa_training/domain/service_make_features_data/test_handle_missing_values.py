...
def test_handle_missing_values_in_sex(
    fixture_handle_missing_values_in_sex: tuple[
    ...
    (
        ...
        df_customer_info,
        df_filled_expected,
    ) = fixture_handle_missing_values_in_sex
...
def test_handle_missing_values_in_age(
    fixture_handle_missing_values_in_age: tuple[
        ServiceMakeFeatures, pd.DataFrame, pd.DataFrame
    ]
):
    """欠損補完, Ageが20で埋まること"""
    ...
    (
        ...
        df_customer_info,
        df_filled_expected,
    ) = fixture_handle_missing_values_in_age
...
def test_handle_missing_values_in_embarked(
    fixture_handle_missing_values_in_embarked: tuple[
        ServiceMakeFeatures, pd.DataFrame, pd.DataFrame
    ]
):
    ...
    (
        ...
        df_customer_info,
        df_filled_expected,
    ) = fixture_handle_missing_values_in_embarked
...
def test_handle_missing_values_in_pclass(
    fixture_handle_missing_values_in_pclass: tuple[
        ServiceMakeFeatures, pd.DataFrame, pd.DataFrame
    ]
):
    """欠損補完, Pclassが2で埋まること"""
    ...
    (
        ...
        df_customer_info,
        df_filled_expected,
    ) = fixture_handle_missing_values_in_pclass
...
def test_handle_missing_values_in_other(
    fixture_handle_missing_values_in_other: tuple[
        ServiceMakeFeatures, pd.DataFrame, pd.DataFrame
    ]
):
    ...
    (
        ...
        df_customer_info,
        df_filled_expected,
    ) = fixture_handle_missing_values_in_other
